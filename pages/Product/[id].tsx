...
export default function Product({id}:any) {
  ...
  const { error, isLoading, data }: any = useQuery(
    `queryKey`,
    async () => await api.getProductData(5),
      
      // await api.getProductData(router.query['id']),
...
console.log(router.query['id']);
  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      <img alt="ecommerce" className=" w-64 h-64 object-fit object-center rounded" src={data.image}/>
      <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        ...
        <div className="flex mb-4">
          ...
          <span className="flex items-center">
            ...
            <span className="text-gray-600 ml-3">{data.rating.rate} Stars</span>
